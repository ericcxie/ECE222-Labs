...
DISPLAY_NUM		STMFD		R13!,{R1, R2, R4, R6, R14}

Counter			LSR			R1, R6, #5		;getting the last 3 bits of 8 bit input
...
IF_ZERO				
					...
					LDMFD 		R13!, {R1, R2, R4, R15}					; Use this command if you used STMFD (otherwise use BX LR) 
